#Scientific Calculator With Voice Command
# Group 1
...
#defining function for voice input


def voicebutton():
        r = s_r.Recognizer()
        my_mic_device = s_r.Microphone(device_index=1)     #use for selection of microphone
        with my_mic_device as source:           
            print("Say what do you want to calculate e.g 3 plus 3")
        ...
        txtDisplay.insert(0,eval_binary_expr(*(my_string.split())))
...
btnlog = Button(calc, text="log",width=6, height=2,bg='white',fg='black', font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.log).grid(row=2, column= 4, pady = 1)

btnExp = Button(calc, text="exp",width=6, height=2,bg='white',fg='black', font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.exp).grid(row=2, column= 5, pady = 1)
...
btnE = Button(calc, text="e",width=6, height=2,bg='white',fg='black', font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.e).grid(row=2, column= 7, pady = 1)

#Row 3:

btnlog10 = Button(calc, text="log10",width=6, height=2,bg='white',fg='black', font=('Helvetica',20,'bold')
                  ,bd=4,command=added_value.log10).grid(row=3, column= 4, pady = 1)

btndeg = Button(calc, text="deg",width=6, height=2,bg='white',fg='black', font=('Helvetica',20,'bold'),
                  bd=4,command=added_value.degrees).grid(row=3, column= 5, pady = 1)


lblDisplay = Label(calc, text = "Scientific Calculator",font=('Helvetica',30,'bold'),
                   bg='black',fg='white',justify=CENTER)
lblDisplay.grid(row=0, column= 4,columnspan=4)
# btnvoice = Button(calc, text="voice input",width=6, height=2,bg='black',fg='white', font=('Helvetica',20,'bold'),
#                   bd=4,command=voicebutton).grid(row=6, column= 3, pady = 1)

# ====================================================================================================== #

# Here are the fucntions for MenuBar.
...
menubar.add_cascade(label = 'VIM' , menu = voicemenu)
voicemenu.add_command(label = "VIM",command= voicebutton)
